...
class CheckoutController extends Controller{
    ...
    public function checkout(){
        ...
        if(Auth::guard('web')->check()){
                ...
                $vendor_wise_cart  = ServicesController::bifercate_cart_vendor_wise($cart);
                foreach ($vendor_wise_cart as $key => $cart_value) {
		            ...
		            $get_vendor_ship_charge  = ServicesController::calculateShippingCharge($pincode, '271313', $height, $width, $length, $weight, $mrp);
    ...
    public function validate_postal_code(Request $request){
