 ...
 public function store(Request $request){
    ...
    public function notify(Request $request){
            ...
            if ($success === true){
                ...
                $order = UserSubscription::where('user_id','=',Session::get('item_number'))->orderBy('created_at','desc')->first();
                ...
                $razorpayOrder = $this->api->order->fetch(session('razorpay_order_id'));
                $order_id = $razorpayOrder['receipt'];
                $payment = UserSubscription::where('user_id','=',$order_id)->orderBy('created_at','desc')->first();
                $payment->delete();
            }
    }
}
