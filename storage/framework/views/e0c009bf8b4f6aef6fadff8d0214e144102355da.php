									...
									<div class="content">
										...
										<div class="billing-address">
											...
											<div class="row">
												...
												<div class="col-lg-6">
													<input class="form-control" type="text" name="zip"  placeholder="<?php echo e($langg->lang159); ?>" required="" value="<?php echo e(Auth::guard('web')->check() ? Auth::guard('web')->user()->zip : ''); ?>">
													<span style="color:red;" id="span_billing_postal_code_error"></span>
												</div>
										...
										<div class="ship-diff-addres-area d-none">
											...
											<div class="row">
												<div class="col-lg-6">
													<input class="form-control ship_input" type="text" name="shipping_city" id="shipping_city" placeholder="<?php echo e($langg->lang158); ?>">
												</div>
												<div class="col-lg-6">
													<input class="form-control ship_input" type="text" name="shipping_zip" id="shippingPostal_code" placeholder="<?php echo e($langg->lang159); ?>">
												</div>
											</div>
										</div>
										...
										<div class="row">
											<div class="col-lg-12  mt-3">
                                                <span style="color:red;" id="span_postal_code_error"></span>
												<div class="bottom-area paystack-area-btn">
													<button type="submit"  class="mybtn1" id="submit_checkout"><?php echo e($langg->lang753); ?></button>
												</div>
											</div>
					...
					<div class="right-area">
						...
						<ul class="order-list">
							...
							<P>
								...
								class="cart-total">&#8377; <?php echo e(Session::get('shipping_cost')); ?></b>
				          ...
				          <div class="login-form signin-form">
				            ...
				            <form id="loginform" action="<?php echo e(route('user.login.submit')); ?>" method="POST">
				              ...
				              <div class="form-input">
				                ...
				                <input type="text" name="email" placeholder="<?php echo e($langg->lang173); ?>" required="">
...
$('#shippingPostal_code').on('change',function(e){
	$.ajax({
        ...
        data:{"_token": "<?php echo e(csrf_token()); ?>", "postal_code": $('#shippingPostal_code').val()},
...
$('.checkoutform').on('submit',function(e){
	var postal_code= !$('input[name="shipping_zip"]').val() ? $('input[name="shipping_zip"]').val() : $('input[name="zip"]').val();
	$.ajax({
        dataType : "json",
        type: "POST",
        url: "validate-postal-code",
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/ecom/ratcart/resources/views/front/checkout.blade.php ENDPATH**/ ?>