						...
						<div class="product-description">
							...
							<div class="body-area">
								<div class="gocover" style="background: url({{asset('assets/images/'.$gs->admin_loader)}}) no-repeat scroll center center rgba(45, 45, 45, 0.5);">
									...
									<div class="row">
										<div class="col-lg-12">
                                           <h4 class="heading">HSN* </h4>
										</div>
										<div class="col-lg-12">
											<input type="text" class="input-field" placeholder="Enter HSN" name="hsn" required="">
										</div>	
									</div>
									<div class="row">
										<div class="col-lg-12">
									...
									<div class="row">
										...
										<div class="col-lg-2">
											<select name="free_delivery" id="free_delivery"  class="input-field">
		                            ...
		                            <div class="row">
										<div class="col-lg-12">
											<div class="left-area">
												<h4 class="heading">Length (In C.M.)* </h4>
											</div>
										</div>
										<div class="col-lg-2">
											<input type="number" class="input-field" placeholder="Enter Height" name="length" required="" value="">
										</div>
									</div>
					                <div class="row">
										<div class="col-lg-12">
											<div class="left-area">
												<h4 class="heading">Height (In C.M.)* </h4>
											</div>
										</div>
										<div class="col-lg-2">
											<input type="number" class="input-field" placeholder="Enter Height" name="height" required="" value="">
										</div>
									</div>
									<div class="row">
										<div class="col-lg-12">
											<div class="left-area">
												<h4 class="heading">Width (In C.M.)* </h4>
											</div>
										</div>
										<div class="col-lg-2">
											<input type="number" class="input-field" placeholder="Enter Width" name="width" required="" value="">
										</div>
									</div>
									<div class="row">
										<div class="col-lg-12">
											<div class="left-area">
												<h4 class="heading">Weight (In K. G.)* </h4>
											</div>
										</div>
										<div class="col-lg-2">
											<input type="number" class="input-field" placeholder="Enter Weight" name="weight" required="" value="">
										</div>
									</div>
									<div class="row">
										<div class="col-lg-12">
