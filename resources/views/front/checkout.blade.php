										...
										<div class="row">
											<div class="col-lg-12  mt-3">
												...
												<div class="bottom-area paystack-area-btn">
													<button type="submit"  class="mybtn1" id="submit_checkout">{{ $langg->lang753 }}</button>
												</div>
											</div>
					...
					<div class="right-area">
						...
						<ul class="order-list">
							...
							<P>
								...
								class="cart-total">&#8377; {{ Session::get('shipping_cost')  }}</b>
				          ...
				          <div class="login-form signin-form">
				            ...
				            <form id="loginform" action="{{ route('user.login.submit') }}" method="POST">
				              ...
				              <div class="form-input">
				                ...
				                <input type="text" name="email" placeholder="{{ $langg->lang173 }}" required="">
