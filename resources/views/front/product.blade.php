...
<section class="product-details-page">
  ...
  <div class="container">
    ...
    @endif
      ...
      <div class="seller-info mt-1" style="border:none !important;">
          <div class="content" style="padding: 4px 0px 6px;">
              <div class="row">
                <div class="col-lg-10" style="padding-left: 0px;">
                    <div class="login-area signup-area" style="-webkit-box-shadow: none; -moz-box-shadow: none; box-shadow: none;">
                      <div class="form-input">
                        <input type="text" name="pin_code" id="pin_code" class="User Name" maxlength="6" placeholder="Enter Pin Code" style="height: 37px; font-size: none; border-radius: 8px;" >
                        <i class="icofont-location-pin"></i>
                      </div>
                    </div>
                </div>
                <div class="col-lg-2" style="padding-left:0px; margin-left: -7px;">
                    <div class="form-input" style="padding-top: 9px;">
                        <a href="#" style="font-style: bold;" id="shippingPostal_code" title="Check Delivery Pin Code Avalibality"><storng>CHECK</storng></a>
                    </div>  
                </div>
                <p id="span_postal_code_success" style="color: green;"></p>
                <p id="span_postal_code_error" style="color: red;"></p> 
              </div>
          </div>
          <div class="content" style="padding: 4px 0px 6px;">
              <div class="row">
...
<script type="text/javascript">
  ...
  $('#shippingPostal_code').on('click',function(e){
      $.ajax({
            type: "GET",
            url: "/validate-postal-code-front/"+$('#pin_code').val()+'/'+$('#product_id').val(),
            success: function(response){
                if(response ==""){
                  $('#span_postal_code_success').text(''); 
                  $('#span_postal_code_error').text("Delivery is not available on this pin code");  
                }
                else{
                  $('#span_postal_code_error').text('');
                  $('#span_postal_code_success').text("Delivery is available | INR "+response);
                }
            },
