  ...
  <div class="left-area">
    <div class="filter-result-area">
      <div class="header-area">
        <h4 class="title">{{$langg->lang61}}</h4>
            </div>
            <div class="body-area">
        ...
        @if(!isset($vendor))
            <div class="tags-area">
                <div class="header-area">
                    <h4 class="title">{{$langg->lang63}}</h4>
                </div>
                <div class="body-area">
                    <ul class="taglist">
                        @foreach(App\Models\Product::showTags() as $tag)
                            @if(!empty($tag))
                                <li><a class="{{ isset($tags) ? ($tag == $tags ? 'active' : '') : ''}}" href="{{ route('front.tag',$tag) }}">{{ $tag }}</a></li>
                            @endif
                        @endforeach
                    </ul>
                </div>
        ...
        @else
            <div class="service-center">
              <div class="header-area"><h4 class="title">{{ $langg->lang227 }}</h4></div>
              <div class="body-area">
                <ul class="list">
                  <li><a href="javascript:;" data-toggle="modal" data-target="{{ Auth::guard('web')->check() ? '#vendorform1' : '#comment-log-reg' }}"><i class="icofont-email"></i> <span class="service-text">{{ $langg->lang228 }}</span></a>
                  </li>
                        <li><a href="tel:+{{$vendor->shop_number}}"><i class="icofont-phone"></i> <span class="service-text">{{$vendor->shop_number}}</span></a></li>
                    </ul>
                </div>
                <div class="footer-area">
                  <p class="title">{{ $langg->lang229 }}</p>
                  <ul class="list">
                      @if($vendor->f_check != 0)
        ...
        @if(isset($slug) && !empty($slug))
          @if(in_array('size', App\Models\Category::getFilterAttributes($slug)))
              <div class="tags-area">
                <div class="header-area">
                ...
                <div class="body-area">
                    <ul class="taglist">
                        @foreach(App\Models\Product::getSize($slug) as $key=> $size)
                            @if(!empty($size))
                                <li><a class="" href="">{{ $size }}</a></li>
                            @endif
                        @endforeach
                    </ul>
                </div>
        ...
        <div class="tags-area">
          ...
          <div class="review-area">
            <div class="star-area">
                <ul class="star-list">
                    <li class="stars" data-val="1"><a id="star_one" style="color: #bdbdbd;" href="{{ route('front.rating-wise-product','1') }}"><i class="fas fa-star"></i></a></li>
                    <li class="stars" data-val="2"><a id="star_two" style="color: #bdbdbd;" href="{{ route('front.rating-wise-product','2') }}"><i class="fas fa-star"></i><i class="fas fa-star"></i></a></li>
                    <li class="stars"  data-val="3"><a id="star_three" style="color: #bdbdbd;" href="{{ route('front.rating-wise-product','3') }}"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i></a></li>
                    <li class="stars"  data-val="4"><a id="star_four" style="color: #bdbdbd;" href="{{ route('front.rating-wise-product','4') }}"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i></a></li>
                    <li class="stars" data-val="5"><a id="star_five" style="color: #bdbdbd;" href="{{ route('front.rating-wise-product','5') }}"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i></a></li>
                  </ul>
              </div>
            </div>
        </div>  
