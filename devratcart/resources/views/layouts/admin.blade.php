						...
						<div class="d-flex justify-content-between">
							...
							<div class="right-eliment">
								<ul class="list">
									...
									<li class="bell-area">
										<a id="notf_conv" class="dropdown-toggle-1" target="_blank" href="{{ route('front.index') }}"><i class="fas fa-globe-americas"></i></a>
									</li>
									<li class="bell-area">
				...
				<div class="wrapper">
					...
					<nav id="sidebar" class="nav-sidebar">
						<ul class="list-unstyled components" id="accordion">
							...
							<li>
								<a href="{{route('admin.seller.index')}}" class="wave-effect"><i class="icofont-verification-check"></i>Seller shipping fees</a>
							</li>
							<li>
								<a href="{{route('admin.seller.seller-faq-list')}}" class="wave-effect"><i class="icofont-verification-check"></i>Seller Faq</a>
							</li>
							<li>
								<a href="{{route('admin.notification.push-notification')}}" class="wave-effect"><i class="fa fa-sms mr-2"></i>Send Message</a>
							</li>
							@else
