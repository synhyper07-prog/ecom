					...
					<div class="footer-widget recent-post-widget">
						...
						<ul class="post-list">
							<li>
								<div class="post">
								  <div class="post-img">
									<img style="height: 50px; width:700px;" src="https://ratcart.com/assets/images/payment_partner.jpg" alt="">
								  </div>
								</div>
							</li>
						</ul>
					...
					<div class="footer-widget recent-post-widget">
						...
						<ul class="post-list">
							<li>
								<div class="post">
								  <div class="post-img">
									<img style="height: 50px; width:700px;" src="https://ratcart.com/assets/images/delivery_partner.jpg" alt="">
								  </div>
								</div>
							</li>
						</ul>
