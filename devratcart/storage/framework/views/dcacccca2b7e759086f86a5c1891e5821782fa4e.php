                ...
                <form class="mregisterform" action="<?php echo e(route('user-register-submit')); ?>" method="POST">
                  ...
                  <ul class="captcha-area">
                    ...
                    <li>
                      ...
                      <p><img class="codeimg1" src="<?php echo e(asset("public/assets/images/capcha_code.png")); ?>" alt=""> <i
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ratcart2a/public_html/devratcart/resources/views/user/login.blade.php ENDPATH**/ ?>