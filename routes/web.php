...
// ************************************ ADMIN SECTION **********************************************
Route::get('/seller', 'Vendor\FrontController@index')->name('vendor.front.index');
Route::get('/seller/vendor-faq', 'Vendor\FrontController@vendorFaq')->name('vendor.front.faq');
Route::get('/seller/fee-structure', 'Vendor\FrontController@feeStructure')->name('vendor.front.fee-structure');
Route::get('/seller/resources', 'Vendor\FrontController@resources')->name('vendor.front.resources');
Route::get('/seller/services', 'Vendor\FrontController@services')->name('vendor.front.services');
Route::get('/seller/vendor-faq-by-id/{id}', 'Vendor\FrontController@vendorFaqById')->name('vendor.front.faq-by-id');
Route::prefix('admin')->group(function() {
  ...
  Route::get('/push-notification-form', 'Admin\NotificationController@pushNotificationFForm')->name('admin.notification.push-notification');
  Route::post('/push-notification-post', 'Admin\NotificationController@send_push_notification')->name('admin.notification.push-notification.post');
  ...
  Route::get('/seller-shipping-fee', 'Admin\SellerController@index')->name('admin.seller.index');
  Route::get('/edit-seller-shipping-fee/{id}', 'Admin\SellerController@editSellerShippingFee')->name('admin.seller.edit-seller-shipping-fess');
  Route::get('/create-price-slab', 'Admin\SellerController@createPriceSlab')->name('admin.seller.create-price-slab');
  Route::post('/post-price-slab', 'Admin\SellerController@postPriceSlab')->name('admin.seller.post-price-slab');

  Route::get('/seller-collection-fee', 'Admin\SellerController@collection')->name('admin.seller.collection');
  Route::get('/edit-seller-collection-fee/{id}', 'Admin\SellerController@editSellerCollectionFee')->name('admin.seller.edit-seller-collection-fess');
  Route::get('/create-collection-slab', 'Admin\SellerController@createCollectionSlab')->name('admin.seller.create-collection-price-slab');
  Route::post('/post-collection-price-slab', 'Admin\SellerController@postCollectionPriceSlab')->name('admin.seller.post-collection-price-slab');



  //-------------------------------Seller Faq----------------------------------------------------------------------//
  Route::get('/seller-faq-list', 'Admin\SellerController@sellerFaqList')->name('admin.seller.seller-faq-list');
  Route::get('/seller-faq-form', 'Admin\SellerController@sellerFaqForm')->name('admin.seller.seller-faq-form');
  Route::post('/post-seller-faq', 'Admin\SellerController@postSellerFaq')->name('admin.seller.post-seller-faq');
  Route::get('/edit-seller-faq-form/{id}', 'Admin\SellerController@sellerEditFaqForm')->name('admin.seller.edit-seller-faq');
  Route::post('/update-seller-faq', 'Admin\SellerController@updateSellerFaq')->name('admin.seller.update-seller-faq');

  Route::get('/view-seller-faq-detail/{id}', 'Admin\SellerController@sellerFaqDetail')->name('admin.seller.view-seller-faq-detail');
  Route::get('/delete-seller-faq/{id}', 'Admin\SellerController@deleteSellerFaq')->name('admin.seller.delete-seller-faq');
  //------------------------End Of Seller Faq---------------------------------------------------------------//
...
Route::prefix('user')->group(function() {
  ...
  Route::post('/vendor-login-post', 'User\LoginController@vendorLoginPost')->name('vendor.login.submit');
  // Vendor Login End
  ...
  Route::post('/vendor-register-post', 'User\RegisterController@vendorRegisterPost')->name('vendor-register-submit');
  Route::post('/get-city-list', 'User\RegisterController@getCityList')->name('get-city-list');
  Route::post('/validate-pin-code/','User\RegisterController@validate_pin_code')->name('validate.pin.code');
  // Vendor Registeration End
  ...
  Route::get('/order/order-item-invoice/{order_id}', 'User\OrderController@order_item_invoice')->name('user-email-invoice');
  ...
  Route::get('/download/order-pdf/{id}', 'User\OrderController@orderPdfDownload')->name('user-order-pdf-download');

  Route::post('/order/cancel', 'User\OrderController@cancel')->name('cancel-order');
...
// ************************************ FRONT SECTION **********************************************
  ...
  Route::get('/get-geolocation', 'Front\GeolocationController@index');

  Route::get('/', 'Front\FrontendController@index')->name('front.index');
  Route::get('/send-otp/{mobile_no?}', 'Front\FrontendController@sendotp')->name('front.sendotp');
  Route::get('/verify-otp/{mobile_no?}/{otp?}', 'Front\FrontendController@verifyotp')->name('front.verifyotp');
  ...
  Route::get('/rating-wise-product/{rating}','Front\CatalogController@ratingWiseProduct')->name('front.rating-wise-product');
  // TAG SECTION ENDS
  ...
  Route::get('/validate-postal-code-front/{pin_code}/{product_id}','Front\CatalogController@validate_postal_code')->name('front.validate.postal.code');
  ...
  Route::post('/validate-postal-code/','Front\CheckoutController@validate_postal_code')->name('validate.postal.code');
