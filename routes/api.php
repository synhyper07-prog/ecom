...
|
*/
Route::get('/delhivery-shipping-creds', [ApiController::class,     'delhivery_shipping_creds']);
Route::get('/base-url', [ApiController::class,     'base_url']);
...
Route::middleware('auth:api')->group( function () {
	...
	Route::post('/check-delivery-avalibality', [ApiController::class, 'checkDeliveryAvalibality']);
	Route::post('/calculate-shipping-charge', [ApiController::class, 'calculateShippingCharge']);
	Route::post('/order-product-detail', [ApiController::class, 'orderProductDetail']);
	Route::get('/get-tracking-status', [ApiController::class, 'getTrackingStatus']);
});
