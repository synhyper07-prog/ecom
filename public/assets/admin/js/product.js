...
$("#feature-btn1").on('click', function(){
    $("#feature-section").append(''+
                            '<div class="feature-area">'+
                                '<span class="remove feature-remove"><i class="fas fa-times"></i></span>'+
                                    '<div  class="row">'+
                                        '<div class="col-lg-6">'+
                                            '<input type="text" name="sub_heading[]" class="input-field" placeholder="Enter Sub headings" required="">'+
                                        '</div>'+
                                        '<div class="col-lg-6"><textarea class="input-field" name="details[]" placeholder="Enter Description" required="" autocomplete="off"></textarea><div>'+
                                    '</div>'+
                            '</div>'
                            +'');
});
